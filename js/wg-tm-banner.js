let tmallBannerRender = (function () {
  // elements
  let container = document.querySelector(".tmall-banner");
  let tmSlideNum = container.querySelector(".tm-hd > strong > i");
  let wrapper = container.querySelector(".tm-bn-wrapper");
  let focus = container.querySelector(".tm-bn-focus");
  let arrowLeft = container.querySelector(".tm-bn-arrowLeft");
  let arrowRight = container.querySelector(".tm-bn-arrowRight");
  let slideList = null;
  let focusList = null;
  ...
  let handleContainer = function () {
    ...
    container.onclick = function (ev) {
      ...
      // focus click
      if (tag === "LI" && par.className.indexOf("tm-bn-focus") > -1) {
      ...
      // arrow click
      if (tag === "A" && target.className.indexOf("tm-bn-arrow") > -1) {
        // left arrow click
        if (target.className.indexOf("tm-bn-arrowLeft") > -1) {
          stepIndex--;
          if (stepIndex < 0) {
